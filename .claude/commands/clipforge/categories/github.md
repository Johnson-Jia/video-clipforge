...
**⛔ 项目重复硬约束（HARD，gate `project_no_consecutive_repeat` 拦截，2026-08-04 airllm 连3期事故）：**
...
**⛔ AI 项目占比硬约束（HARD，gate `ai_project_cap` 拦截，2026-08-05 有 ai-wind 专项后差异化）：**
...
**⛔ 跨频道 AI 去重（SOFT，2026-08-14 反馈）：** daily 选 AI 项目时，**避开昨日 ai-wind 已选的 AI 项目**（inject 会注入清单）——观众同一天/连续两天刷到同一 AI 项目会觉重复。虽 gate 仅同频道硬拦，但跨频道（daily ↔ ai-wind）观众视角重复也要主动避开。非 AI 项目不受此约束。
...
### security_tools — 安全工具入池规则（2026-08-14 反馈落地）
...
> **⛔ hook 具象度反例（2026-07-29 c5s 下钻验证，drill-c5s）**：
...
### ending_question — 结尾提问（2026-06-21 更新：禁站队对抗式）
...
> - **禁站队/对抗式**：「你站谁」「X 和它你站谁」「你敢说真香吗」「我吹爆你敢说吗」——"站谁"营销感强、对抗意味重，观众反感（2026-06-21 用户反馈，覆盖旧"站队评论率高 3-5×"建议）
